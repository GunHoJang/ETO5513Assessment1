...
Although the scatter plot provides clarity on the data, it can be better represented as a box plot to display median, quartiles and outlier data.

```{r data visualisation - part b}
